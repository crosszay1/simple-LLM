...
Although democracy is in purely representative democracies understood to be defined by voting, no consensus exists on a precise definition of democracy 
(see also In the search of common understanding below), 
There are many approaches. A study identified 2,234 adjectives used to describe democracy in the English language.
