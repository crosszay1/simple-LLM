...
Humanity has achieved space flight, but only a few nations have the technology for orbital launches: Russia (Roscosmos), the United States (NASA), the member states of the European Space Agency, Japan (JAXA), China (CNSA), India (ISRO), Taiwan (TSA), Israel (ISA), Iran (ISA), and North Korea (NATA). In addition, several private companies have developed or are developing the technology for orbital launches independently from government agencies. Two prominent examples of such companies are SpaceX and Blue Origin.
